...
class __TwigTemplate_ebced08717e0c5dfe12bab8d58323719 extends Twig_Template
{
    ...
    {
        // line 3
        $context["__internal_12aae7f3d68e4dc1d80435ab2f0e261cf2903228"] = $this;
        // line 5
...
";
    ...
    ";
        // line 82
        echo $context["__internal_12aae7f3d68e4dc1d80435ab2f0e261cf2903228"]->getdisplay_timeline(("timeline_" . $this->getContext($context, "token")), $this->getAttribute($this->getContext($context, "collector"), "events"), $this->getContext($context, "colors"));
        echo "
    ...
    ";
        ...
        if (twig_length_filter($this->env, $this->getAttribute($this->getContext($context, "profile"), "children"))) {
            ...
            ";
                // line 92
                echo $context["__internal_12aae7f3d68e4dc1d80435ab2f0e261cf2903228"]->getdisplay_timeline(("timeline_" . $this->getAttribute($this->getContext($context, "child"), "token")), $this->getContext($context, "events"), $this->getContext($context, "colors"));
                echo "
        ";
            }
...
";
        // line 393
        echo $context["__internal_12aae7f3d68e4dc1d80435ab2f0e261cf2903228"]->getdump_request_data($this->getContext($context, "token"), $this->getContext($context, "profile"), $this->getAttribute($this->getContext($context, "collector"), "events"), $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "events"), "__section__"), "origin"));
        echo "
...
";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
                // line 398
                echo $context["__internal_12aae7f3d68e4dc1d80435ab2f0e261cf2903228"]->getdump_request_data($this->getAttribute($this->getContext($context, "child"), "token"), $this->getContext($context, "child"), $this->getAttribute($this->getAttribute($this->getContext($context, "child"), "getcollector", array(0 => "time"), "method"), "events"), $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "events"), "__section__"), "origin"));
...
";
    ...
    public function getdump_request_data($token = null, $profile = null, $events = null, $origin = null)
    {
        ...
        try {
            // line 432
            $context["__internal_d07913520008520f4287012dc85a1648cb039a8f"] = $this;
            // line 433
            echo "                {
                    \"id\": \"";
            // line 434
...
";
            // line 437
            echo $context["__internal_d07913520008520f4287012dc85a1648cb039a8f"]->getdump_events($this->getContext($context, "events"));
            echo "
                    ]
                }
";
